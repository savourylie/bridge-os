...
| 004 | [**TEST: Checkpoint 0 — Foundation Scaffold**](./004-test-checkpoint-0-foundation.md)      | `pending` | #003 ✅    | Gate: Phase 1 — Unblocked |

## Phase 2 — Core UI Components

| #   | Ticket                                                                                     | Status    | Depends On       | Notes |
| --- | ------------------------------------------------------------------------------------------ | --------- | ---------------- | ----- |
| 005 | [StatusCapsule](./005-status-capsule.md)                                                   | `blocked` | #004             |       |
| 006 | [VoiceBar](./006-voice-bar.md)                                                             | `blocked` | #004             |       |
| 007 | [IntentBoard](./007-intent-board.md)                                                       | `blocked` | #004             |       |
| 008 | [DraftPlan](./008-draft-plan.md)                                                           | `blocked` | #004             |       |
| 009 | [TaskPanel Shell](./009-task-panel-shell.md)                                               | `blocked` | #004             |       |
