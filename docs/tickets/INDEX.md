...
> **Last updated**: 2026-04-26 (TICKET-031 done, TICKET-032 unblocked)
...
| 026 | [Folder Organization Flow](./026-folder-organization-flow.md)                              | `done`    | #024 ✅, #025 ✅ | Folder organization flow complete |
| 027 | [Project Inspection & Commands](./027-project-inspection-and-commands.md)                   | `done`    | #024 ✅, #025 ✅ | Project inspection & guarded commands complete |
| 028 | [**TEST: Checkpoint 5 — Mock Task Flows**](./028-test-checkpoint-5-mock-flows.md)          | `done`    | #026 ✅, #027 ✅ | Gate: Phase 6 — All criteria passed |

## Phase 7 — Voice Pipeline

| #   | Ticket                                                                                     | Status    | Depends On       | Notes |
| --- | ------------------------------------------------------------------------------------------ | --------- | ---------------- | ----- |
| 029 | [Speech-to-Text](./029-speech-to-text.md)                                                  | `done`    | #028 ✅          | Web Speech STT complete |
| 030 | [Text-to-Speech](./030-text-to-speech.md)                                                  | `done`    | #028 ✅          | Browser TTS complete |
| 031 | [Turn-Taking & Interruption](./031-turn-taking-and-interruption.md)                        | `done`    | #029 ✅, #030 ✅ | Turn-taking, status query & redirection complete |
| 032 | [**TEST: Checkpoint 6 — Voice Pipeline**](./032-test-checkpoint-6-voice-pipeline.md)       | `pending` | #031 ✅          | Gate: Phase 7 — Unblocked |
